...
class AsociacionEncuestaForm(models.ModelForm):

    programas = forms.ModelMultipleChoiceField(queryset=ProgramaAcademico.objects.filter(activo=True), widget=forms.CheckboxSelectMultiple)
