...
class AplazarCursoForm(Form):
    ...
    valor_saldo_a_favor = forms.FloatField(label='Valor a cargar como saldo a favor del usuario',widget=forms.NumberInput(attrs={"min": 0, 'oninput': "validity.valid||(value='');"}))
