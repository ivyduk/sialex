...
class DireccionSelectorWidget(forms.widgets.MultiWidget):
    ...
    def __init__(self, attrs=None):
        ...
        widgets = (
            ...
            forms.widgets.NumberInput(attrs={'class':'input-address', 'placeholder': 'N°', 'maxlength':3,'min':1,'max':200}),
            ...
            forms.widgets.TextInput(
                attrs={'class': 'input-addressNumber', 'readonly': 'readonly', 'placeholder': '#'}),
            forms.widgets.NumberInput(attrs={'class':'input-address', 'placeholder': 'N°', 'maxlength':3,'min':1,'max':200}),
            forms.widgets.Select(attrs={'class':'input-address', 'maxlength': 1}, choices=DIRECCION_LETRA),
            forms.widgets.Select(attrs={'class':'input-address'}, choices=DIRECCION_PREFIJO),
            forms.widgets.TextInput(
                attrs={'class': 'input-addressNumber', 'readonly': 'readonly', 'placeholder': '-'}),
            forms.widgets.NumberInput(attrs={'class':'input-address', 'placeholder': 'N°','maxlength':3,'min':1,'max':200}),
            forms.widgets.TextInput(attrs={'class':'input-addressAdi', 'placeholder': 'Información Adicional'}),
            )
...
class EditProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        exclude = ['primer_nombre', 'primer_apellido', 'fecha_nacimiento', 'indicativo_fijo', 'indicativo_celular',
                   ...
                   'acepta_habeas_data', 'documento_identificacion_entregado', 'direccion_residencia']
